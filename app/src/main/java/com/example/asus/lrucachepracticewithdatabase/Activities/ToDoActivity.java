...
import com.example.asus.lrucachepracticewithdatabase.Adapters.FinishedAdapter;
import com.example.asus.lrucachepracticewithdatabase.Fragments.FinishedFragments;
...
public class ToDoActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tab = (TabLayout) findViewById(R.id.menu_tab);
        ...
        tab.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                if(tab.getPosition()==0){
                    ...
                    Gson gson = new Gson();
                    String json = gson.toJson(doneActivities);

                    Bundle bundle = new Bundle();
                    bundle.putString("arrayList", json);
                    FinishedFragments fragobj = new FinishedFragments();
                    fragobj.setArguments(bundle);
                    FragmentManager fragmentManager = getFragmentManager();
                    fragmentManager.beginTransaction().replace(R.id.frameContainer,fragobj).commit();
                }
    ...
    protected void onStop() {
        ...
        //String json2 = gson.toJson(doneActivities);
    ...
    public void passData(int position){
        ...
        doneActivities.add(arr.get(position));
        Gson gson = new Gson();
        String json = gson.toJson(doneActivities);
        ...
        fragobj.setArguments(bundle);
        FragmentManager fragmentManager = getFragmentManager();
        fragmentManager.beginTransaction().replace(R.id.frameContainer,fragobj).addToBackStack(null).commit();
        TabLayout.Tab tb = tab.getTabAt(1);
        tb.select();
    }
}
